...
class Stats:
    ...
    def attitude_response(self):
        ...
        att_data = (
            self.int_response(raw_att[0]),
            self.int_response(raw_att[1]),
            self.int_response(raw_att[2]),
        )
        return att_data
    ...
    def acceleration_response(self):
        ...
        acc_data = (
            self.float_response(raw_acc[0]),
            self.float_response(raw_acc[1]),
            self.float_response(raw_acc[2]),
        )
        return acc_data
